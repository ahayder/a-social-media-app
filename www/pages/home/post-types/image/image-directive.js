...
iController.$inject = ['$scope', 'Constants', '$ionicPopover', '$localStorage', 'HomeFactory', '$state', 'ionicToast'];

function iController($scope, Constants, $ionicPopover, $localStorage, HomeFactory, $state, ionicToast) {
    var vm = this;
