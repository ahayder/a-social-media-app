...
alController.$inject = ['$scope', 'Constants', '$ionicPopover', '$localStorage', 'HomeFactory', '$state', 'ionicToast'];

function alController($scope, Constants, $ionicPopover, $localStorage, HomeFactory, $state, ionicToast) {
    var vm = this;
